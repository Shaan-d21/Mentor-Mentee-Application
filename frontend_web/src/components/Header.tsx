                ...
                <div className="absolute right-0 mt-2 w-48 bg-white border rounded-md shadow-lg z-50">
                  <ul className="py-2">
                    <li
                      ...
                      className="px-4 py-2 cursor-pointer transition-all text-gray-700 hover:bg-[#2D6A4F] hover:text-white"
                    >
                      View Profile
                    </li>
                    <li
                    ...
                    <li
                      ...
                      className="px-4 py-2 cursor-pointer transition-all text-red-500 hover:bg-[#2D6A4F] hover:text-white"
                    >
                      Logout
                    </li>
                  </ul>
