...
def matching(domain_choice: str):
        ...
        for mentor in available_mentors:
            ...
            s_p = np.array([skill_dict['proficiency'] for skill_dict in mentor['skills']])
            proficiency_mapping = {
                'beginner': 1,
                'intermediate': 2,
                'advanced': 3
            ...
            # Convert proficiency to numeric values
            skill_proficiencies = [proficiency_mapping.get(i, 0) for i in s_p]
            ...
            normalized_proficiency = (np.array(skill_proficiencies) - 1) / (5 - 1)
